angular.module('angularTest')
  .directive('renderTemplate', function ($compile) {
    ...
    var template6 = '<div class="{{section.content.class}} {{section.textColor}}"><div class="tile"><h2 editable-context ng-data-model="section.content.header" element-type="text">{{section.content.header}}</h2><p class="subTitle" editable-context ng-data-model="section.content.subtitle" element-type="text">{{section.content.subtitle}}</p><button><span>Buy</span></button></div><div class="heroImg heroProductImg userUploadable" ng-class=\'{{section.content.heroImage.image.src == "" ? "uploadImg" : ""}}\'><span class="fileUploadScreen"></span><label for="heroBG">Browse<input type="file" id="heroBG" set-target=".heroProductImg" create-img-elem=true file-model="section.content.heroImage.image.src"/></label></div></div></div>';
    var template7 = '<div class="{{section.content.class}} {{section.textColor}}"><div class="heroImg userUploadable heroProductImgv2"><span class="fileUploadScreen"></span><label for="heroBG">Browse<input type="file" id="heroBG" set-target=".heroProductImgv2" create-img-elem="true" file-model="section.content.heroImage.image.src"/></label></div><h2 editable-context ng-data-model="section.content.header" element-type="text">{{section.content.header}}</h2><p class="subTitle" editable-context ng-data-model="section.content.subtitle" element-type="text">{{section.content.subtitle}}</p></div></div></div>';
    var template8 = '<div class="{{section.content.class}} {{section.textColor}}"><h2 editable-context ng-data-model="section.content.header" element-type="text">{{section.content.header}}</h2><p class="subTitle" editable-context ng-data-model="section.content.subtitle" element-type="text">{{section.content.subtitle}}</p><div class="column"><div ng-repeat="item in section.content.columns"><div class="heroImg"></div><div class="wrap"><h3 editable-context ng-data-model="item.title" element-type="text">{{item.title}}</h3><span class="tagline" editable-context ng-data-model="item.title" element-type="text">{{item.description}}</span><p editable-context ng-data-model="item.description" element-type="textarea">{{item.description}}</p></div></div></div></div>';
    var template9 = '<div class="{{section.content.class}} {{section.textColor}}"><h2 editable-context ng-data-model="section.content.header" element-type="text">{{section.content.header}}</h2><p class="subTitle" editable-context ng-data-model="section.content.subtitle" element-type="text">{{section.content.subtitle}}</p><div class="row"><div ng-repeat="item in section.content.rows"><div class="heroImg"></div><div class="wrap"><h3 editable-context ng-data-model="item.title" element-type="text">{{item.title}}</h3><span class="tagline" editable-context ng-data-model="item.tagline" element-type="text">{{item.tagline}}</span><p editable-context ng-data-model="item.description" element-type="textarea">{{item.description}}</p></div></div></div></div>';
    var template10 = '<div class="{{section.content.class}} {{section.textColor}}"><h2 editable-context ng-data-model="section.content.header" element-type="text">{{section.content.header}}</h2><p class="subTitle" editable-context ng-data-model="section.content.subtitle" element-type="text">{{section.content.subtitle}}</p><ul class="imageStack"><li ng-repeat="item in section.content.gallery"></li></ul></div>';
